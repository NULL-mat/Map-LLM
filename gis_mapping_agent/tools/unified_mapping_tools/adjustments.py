    ...
    def remove_layer(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            self.current_map_state.legend_items = [
                ...
                and (item.style or {}).get("layer_name") != layer_name
                and (item.style or {}).get("_layer_name") != layer_name
            ]
    ...
    def toggle_layer_visibility(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if target_layer.visible:
                # 如果图层变为可见，确保图例项存在
                existing_item = any(
                    item.label == chinese_name
                    or (item.style or {}).get("layer_name") == layer_name
                    or (item.style or {}).get("_layer_name") == layer_name
